...
class RockPaperScissors(commands.Cog, name="Rock Paper Scissors"):
    ...
    async def challenge(self, ctx, user):
        ...
        embed.add_field(
            ...
            value=f"Respond with 'rock', 'paper' or 'scissors'! You can also submit 'decline' to decline the match."
        )
        embed.add_field(
            name=f"How do I respond?",
            value=f"Click on the emoji which you want your answer to be. If you don't want to respond click on the red X."
        )
